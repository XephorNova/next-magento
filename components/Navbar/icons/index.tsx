...
const TagUserIcon: React.FC<svgProps> = ({
  fill,
  size,
  width = 24,
  height = 24,
...
const ServerIcon: React.FC<svgProps> = ({
  fill,
  size,
  width = 24,
  height = 24,
...
const FlashIcon: React.FC<svgProps> = ({
  fill,
  size,
  width = 24,
  height = 24,
...
const ActivityIcon: React.FC<svgProps> = ({
  fill,
  size,
  width = 24,
  height = 24,
...
const ScaleIcon: React.FC<svgProps> = ({
  fill,
  size,
  width = 24,
  height = 24,
...
export const icons = {
  ...
  search: <SearchIcon fill="none" size={30} />,
};
